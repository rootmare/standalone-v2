...
// #Class:                |NC WEB DEV
// #Date:                 |22/04/25
// #Name of program:      |quiz.js
// #purpose of prgram:    |to be a quiz
let totalScore = 0;
...
function topic(choice){
    ...
    console.log(quizes[choice].questions[0])
    quiz(choice)
...
function setQuestion( i, choice ){
    document.getElementById('question').innerHTML = quizes[choice][questions][i];
    document.getElementById('a').innerHTML = quizes[choice][responsives][i];
    document.getElementById('b').innerHTML = quizes[choice][responsives][ i + 1 ];
    document.getElementById('c').innerHTML = quizes[choice][responsives][ i + 2 ];
    document.getElementById('d').innerHTML = quizes[choice][responsives][ i + 3 ];
}

function checkAnswer(btn, i , choice){
    if( btn === quizes[choice][answers][i]){
        totalScore++;
        document.getElementById(quizes[choice][answers][i]).style.color="green";
    }
    else
    {
...
function quiz(choice){
    ...
    console.log(choice);
    console.log(i);
    setQuestion(i, choice);

    i++
    //checkAnswer(btn, i, choice)
